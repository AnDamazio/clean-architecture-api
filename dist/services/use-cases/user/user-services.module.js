...
const user_services_service_1 = require("./user-services.service");
...
UserServicesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [user_factory_service_1.UserFactoryService, user_services_service_1.UserServices],
        exports: [user_factory_service_1.UserFactoryService, user_services_service_1.UserServices],
    })
], UserServicesModule);
